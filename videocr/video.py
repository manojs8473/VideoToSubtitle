...
class Video:
    ...
    def run_ocr(self, use_gpu: bool, lang: str, time_start: str, time_end: str,
        ...
        self.pred_frames = []
        ocr = PaddleOCR(lang=self.lang, rec_model_dir=self.rec_model_dir, det_model_dir=self.det_model_dir, use_gpu=use_gpu,show_log = False)
            ...
            for i in range(num_ocr_frames):
                if i % modulo == 0:
                    ...
                    if (ocr_pred[0]!=None):
                        ...
                        predicted_frames = PredictedFrames(i + ocr_start, ocr_pred, conf_threshold_percent)
